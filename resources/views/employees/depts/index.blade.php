...
@section('title', 'Employee Departments')
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-form d-flex justify-content-center">
                            <a href="{{ route('employee_depts.edit', $dept->id) }}" class="btn btn-primary mr-lg-2"><i class="fa fa-pen-to-square" aria-hidden="true"></i></a>
                            <form action="{{ route('employee_depts.destroy', $dept->id) }}" method="post" class="delete-form">
                                @csrf
                                @method('DELETE')
