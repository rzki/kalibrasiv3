...
@section('title', 'Create New Positions')
...
<div class="container-fluid px-3">
    <div class="row pt-3">
            <a href="{{ route('employee_positions.index') }}" class="btn btn-info text-right">
...
<div class="container-fluid px-3">
    <div class="row flex-column">
        <form action="{{ route('employee_positions.store') }}" method="post" class="pt-5">
            @csrf
